    ...
    />
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
            ...
            fast, scalable, and user-friendly web applications using the MERN
            stack (MongoDB, Express.js, React.js, Node.js) and Next.js. I
            specialize in crafting intuitive frontends with React.js, Vue.js,
            and Bootstrap, and building robust backend services with a strong
            focus on API design, performance optimization, and security. I’ve
            also worked on seamless integrations with third-party platforms like
            Stripe, Customer.io, and Microsoft Clarity. I’m passionate about
